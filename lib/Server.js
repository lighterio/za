...
module.exports = function Server() {
  ...
  /**
   * returns requestListener compatible interface
   * which can be used to create server using node http or https require
   *
   * This function is useful to make za nodejs server compatible.
   * It also helps setup a testing environment using supertest
